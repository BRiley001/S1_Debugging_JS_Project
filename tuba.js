...
function verifyCrops() {
    try {
        ...
        if (i === 7) {
            //tells the user that they need to select a crop
    ...
    //makes the recomendations appear correctly
    cropsComplete = true;
}
...
function createEventListeners() {
    ...
    for (var i = 0; i < 3; i++) {
        ...
        //makes the diesel box checked, which is the default option anyways
